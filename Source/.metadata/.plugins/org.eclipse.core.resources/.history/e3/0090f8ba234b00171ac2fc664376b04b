 ...
 * Blogrole entities. Transaction control of the save(), update() and delete()
...
public class BlogroleDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory.getLogger(BlogroleDAO.class);
	// property constants
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Blogrole instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Blogrole as model where model." + propertyName + "= ?";
	...
	public List findByBlogRoleName(Object blogRoleName) {
		return findByProperty(BLOG_ROLE_NAME, blogRoleName);
	}

	public List findAll() {
		log.debug("finding all Blogrole instances");
		try {
			String queryString = "from Blogrole";
	...
	public static BlogroleDAO getFromApplicationContext(ApplicationContext ctx) {
		return (BlogroleDAO) ctx.getBean("BlogroleDAO");
	}
}