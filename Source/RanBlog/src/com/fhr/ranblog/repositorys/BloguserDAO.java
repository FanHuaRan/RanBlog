 ...
 * Bloguser entities. Transaction control of the save(), update() and delete()
...
public class BloguserDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory.getLogger(BloguserDAO.class);
	// property constants
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Bloguser instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Bloguser as model where model." + propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Bloguser instances");
		try {
			String queryString = "from Bloguser";
	...
	public static BloguserDAO getFromApplicationContext(ApplicationContext ctx) {
		return (BloguserDAO) ctx.getBean("BloguserDAO");
	}
}